        ...
        let resMsg = {
            ...
            messages: [
                ...
                // },
                {
                    ...
                    "payload": {
                        "type": "genericCard",
                        "text": "Hi " + userInfo.FirstName + " " + userInfo.LastName + " , Here are your existing Portfolio details for variable annuity policy No <b>" + policyNo + "<b> </br>",
                        "image": "https://static1.valueresearchonline.com/story/images/23898_28-Oct-2015-BigQuestion.png",
                        "buttons":[{
                            "content_type": "text",
                            "title": "Portfolio details",
                            "payload": "Portfolio details"
                        }],
                        "data": {
