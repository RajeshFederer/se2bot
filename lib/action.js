                        ...
                        "data": {
                            ...
                            BeforeFundSwitch: {
                                "Equity": {
                                    ...
                                    "CashValue": data.BeforeCashVal,
                                    "Units": data.BeforeOutstanding,
                                    "UnitValue": data.EquityNAV,
                                    "Current%": data.BeforePercentSplit
                                },
                                "Bond": {
                                    "FundName": data.BondFundName,
                                    "CashValue": data.BeforeMMCashVal,
                                    "Units": data.BeforeMMOutstanding,
                                    "UnitValue": data.BondNAV,
                                    "Current%": data.BeforeMMPercentSplit
                                },
                                "TotalCashValue" : data.CurrentTotalCashValue
                            },
                            fundSwitchDetails : {
                                "Equity": {
                                    "target%" : data.RecommendedEquitySplit,
                                    "inAmount": data.AfterCashValue,
                                    "AmtBeSwitched": data.AmtBeSwitched,
                                    "SwitchOutPer" : data.Switchoutpercent,
                                    "SwitchOutUnits" : data.Switchoutunits,
                                    "SwitchInPer" : data.Switchinpercent,
                                    "SwitchInAmount" : data.SwitchinAmount
                                },
                                "Bond": {
                                    "target%" : data.RecommendedMM,
                                    "inAmount": data.AfterMMCashValue,
                                    "AmtBeSwitched": data.MMAmtBeSwitched,
                                    "SwitchOutPer" : data.MMSwitchoutpercent,
                                    "SwitchInPer" : data.MMSwitchinpercent,
                                    "SwitchInAmount" : data.MMSwitchinAmount
                                },
                                "TotalInAmount" : data.TotalRecommValue
                            },
                            AfterFundSwitch: {
                                "Equity": {
                                    "FundName": data.EquityFundName,
                                    "CashValue": data.AfterCashVal,
                                    "Units": data.AfterEquityUnits,
                                    "UnitValue": data.EquityNAV,
                                    "Current%": data.RecommendedEquitySplit,
                                },
                                "Bond": {
                                    "FundName": data.BondFundName,
                                    "CashValue": data.AfterMMCashValue,
                                    "Units": data.AfterMMEquityUnits,
                                    "UnitValue": data.BondNAV,
                                    "Current%": data.RecommendedMM
                                }
                            }
                        }
                    },
...
action.statusOfFundSwitch = (req, res) => {
    let userInfo = cusInfo[req.body.sessionId];
    if (userInfo) {
        chatLog[req.body.sessionId] += "</br> USER : " + req.body.result.resolvedQuery + "</br> BOT: As per our records <b>" + userInfo.FirstName + " " + userInfo.LastName + " </b>,  your fund switch request submitted at 13:30:00 ET for Policy Number <b>" + userInfo.policyDetails.policyNo + "</b> has been successfully submitted and your transaction id is TRN837377389. </br> Do you need any further assistance with your investment options?";
        return res.json({
            speech: '',
            messages: [
                {
