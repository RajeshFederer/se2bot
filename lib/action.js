...
function bpmCall(userInfo, cLog, dTime) {
    ...
    let serviceNowUrl = 'https://ustrial01.bpm.ibmcloud.com/bpm/dev/rest/bpm/wle/v1/process?action=start&bpdId=25.33574618-af8b-4ee6-90c3-1613667d3c7e&processAppId=2066.3ca235e7-d0ac-46e9-80fd-b4c08f5ff52e&params={"policyBasicInfo": {"policyName":"Policy Name","policyNo": "'+userInfo.policyDetails.PolicyNumber +'","companyName":"'+userInfo.Employer+'","policyStatus":"'+userInfo.policyDetails.PolicyStatus+'", "planName":"PlanA", "planDate": "04-04-2018"} }, {"chatHistory" : "'+cLog+'" }, { "appointmentTime" : "'+dTime+'" }&parts=all';
    let reqBody = {
        // "policyBasicInfo": {
