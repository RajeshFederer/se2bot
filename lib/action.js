...
function bpmCall(userInfo, cLog) {
    ...
    let serviceNowUrl = 'https://ustrial01.bpm.ibmcloud.com/bpm/dev/rest/bpm/wle/v1/process?action=start&bpdId=25.33574618-af8b-4ee6-90c3-1613667d3c7e&processAppId=2066.3ca235e7-d0ac-46e9-80fd-b4c08f5ff52e&params={"policyBasicInfo": {"policyName":"PolicyCreatedFromSOAPUI","policyNo": "79387453487","companyName":"Hexaware","policyStatus":"Active", "planName":"PlanA", "planDate": "04-04-2018"} }, {"chatHistory" : "Hello Fredrick Johnson Dakoba" }, { "appointmentTime" : "10th April 3-5 pm" }&parts=all';
    let reqBody = {
        // "policyBasicInfo": {
