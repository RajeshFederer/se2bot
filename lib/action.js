                        ...
                        "data": {
                            ...
                            fundSwitchDetails : {
                                "Equity": {
                                    ...
                                    "AmtBeSwitched": data.AmtBeSwitched ? data.AmtBeSwitched: 0,
                                    "SwitchOutPer" : data.Switchoutpercent ? data.Switchoutpercent: 0,
                                    "SwitchOutUnits" : data.Switchoutunits ? data.Switchoutunits : 0,
                                    "SwitchInPer" : data.Switchinpercent ? data.Switchinpercent: 0,
                                    "SwitchInAmount" : data.SwitchinAmount ? data.SwitchinAmount : 0
                                },
                                "Bond": {
                            ...
                            AfterFundSwitch: {
                                "Equity": {
                                    "FundName": data.EquityFundName ? data.EquityFundName : 0,
                                    "CashValue": data.AfterCashVal ? data.AfterCashVal : 0,
